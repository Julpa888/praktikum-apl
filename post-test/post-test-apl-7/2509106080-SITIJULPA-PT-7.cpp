...
int inputAngka(string pesan, int min = -999999, int max = 999999) {
    int nilai;
    while (true) {
        try {
            cout << pesan;
            string line;
            getline(cin, line);
            if (line.empty()) throw runtime_error("Input harus berupa angka!");
            size_t pos;
            nilai = stoi(line, &pos);
            if (pos != line.size()) throw runtime_error("Input harus berupa angka!");
            if (nilai < min || nilai > max) throw runtime_error("Input di luar batas yang diperbolehkan!");
            return nilai;
        }
            ...
            cout << "\nError: Input di luar batas yang diperbolehkan!" << endl;
        }}}
...
void tambahKarakter(Karakter karakter[], int* panjang){
    ...
    karakter[*panjang].build.cost = inputAngka("Masukkan cost pattern: ", 1, 999999);
...
void ubahKarakter(Karakter karakter[], int panjang){
    int index = inputAngka("\nMasukkan nomor karakter yang ingin diubah: ", 1, panjang);
    ...
    target->build.cost = inputAngka("Masukkan cost pattern: ", 1, 999999);
    cout << "Masukkan team comp:" << endl;
    cout << "1. ";
...
void hapusKarakter(Karakter karakter[], int* panjang){
    int index = inputAngka("\nMasukkan nomor karakter yang ingin dihapus: ", 1, *panjang);
...
void tambahWishlist(int wishlistIndex[], int* jumlahWishlist, int panjang){
    ...
    int pilih = inputAngka("\nPilih nomor karakter untuk wishlist: ", 1, panjang);
    int index = pilih - 1;
...
void hapusWishlist(int wishlistIndex[], int* jumlahWishlist){
    int pilih = inputAngka("\nPilih nomor wishlist yang ingin dihapus: ", 1, *jumlahWishlist);
    int index = pilih - 1;
            ...
            if (hasilLogin == 0){
                ...
                while (true) {
                    ...
                    if (pilihan == 1){
                        ...
                        int costCari = inputAngka("\nMasukkan cost pattern yang dicari: ", 1, 999999);
